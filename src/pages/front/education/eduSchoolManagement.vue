      ...
      <div class="teacher-table tables">
        <el-table
          ...
          <el-table-column
            ...
            width="160">
            <template scope="props">
              <router-link :to="{ path:  '/eduSchoolManagement/schoolinfo/'+props.row.id }" class="link-text" style=" text-decoration: underline;"><span>查看</span></router-link>
  ...
  export default {
    ...
    data () {
      ...
      return {
        ...
        schoolTypeList: [{name:'小学', label:6}, {name:'完小', label:8}, {name:'初中', label:3}, {name:'九年一贯制', label:5}, {name:'高中', label:2}, {name:'完中', label:4}, {name:'职业高中', label:9}, {name:'普通高等学校', label:12}], //学段
        positionStrList: [{name:'中心城区', label:1}, {name:'城乡结合', label:2}, {name:'近郊', label:3}, {name:'远郊', label:4}, {name:'山区', label:5}],  //地理位置
...
<style>
  ...
  #eduSchoolManagement .edu-text { position: absolute; left: 100px; top: 10px; /*color: #20a0ff;*/ color: #333;}
  ...
  #eduSchoolManagement .search { padding: 15px 20px 15px 75px; border: 1px solid #cedaea; border-top:3px solid #0d9ee9; margin-top: 18px; margin-bottom: 16px; position: relative;}
