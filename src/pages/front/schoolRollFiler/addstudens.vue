  ...
  <div id="addstudent">
    ...
    <el-form :model="studentForm" :rules="rules" ref="studentForm" label-width="140px" class="demo-studentForm">
      <div>
        ...
        <div class="title"><i></i><span>选择导入班级</span></div>
      ...
      <el-form-item label="身份证号：" prop="idCard">
        <el-input v-model.trim="studentForm.idCard"class="inputWidth"></el-input>
      </el-form-item>
      <el-form-item label="出生年月日：" prop="birthday" style="height: 36px">
        <el-col :span="11">
          <el-form-item>
      ...
      <el-form-item label="电话：" prop="fatherPhone" >
        <el-input v-model.trim="studentForm.fatherPhone" placeholder="请填写电话" class="inputWidth"></el-input>
      </el-form-item>
      ...
      <el-form-item label="电话：" prop="motherPhone">
        <el-input v-model.trim="studentForm.motherPhone" placeholder="请填写电话" class="inputWidth"></el-input>
      </el-form-item>
...
#addstudent .el-form-item__label{
    color:#333;
  }
  #addstudent {
