      ...
      <div class="teacher-table tables">
        <el-table
          ...
          <el-table-column
            ...
            width="200">
            <template scope="props">
              <router-link :to="{ path: '/teacherManagement/editteachers/detail/'+props.row.id }" class="link-text">查看</router-link>
...
//        console.log(' count:'+count);
      ...
      isFirstLogin() {
        ...
        const left = ((clientWidth - 1024)/2 + 18) + 'px';
        this.noticeStyle = {
          left: left
        };
        if ( this.firstLogin ) {
...
<style>
  #teacherManagement { padding: 0 20px 20px;}
  ...
  #teacherManagement .btns { border-bottom: 1px solid #ECEDEF; padding-bottom: 15px; padding-top: 15px;}
  #teacherManagement .teacher-nodata { background: url("../../../resources/front/imgs/nodata.png") no-repeat center; text-align: center; padding-top: 100px; height: 233px; position: relative;}
  #teacherManagement .teacher-nodata .text { position: absolute; bottom: 0; width: 100%; text-align: center; font-size: 14px; color: #b6b6b6;}
  ...
  #teacherManagement .first-login-notice { position: fixed; top: 0; right: 0; bottom: 0; left: 0; z-index: 2002; background-color: rgba(0, 0, 0, 0.6);}
  #teacherManagement .teacher-batch-notice { position: fixed; z-index: 2003; left: -1000px; top: 102px; width: 320px; height: 156px; background: url("../../../resources/front/imgs/teacher-notice.png") no-repeat center;}
