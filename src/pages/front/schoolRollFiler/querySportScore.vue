<template>
  <div class="queryScore publicScore"v-loading="loadingStatus">
...
//          if (this.errorMsg > 0){
//            this.$alert('您输入修改的成绩格式有误, 一共有'+this.errorMsg+'处，请您修改后从新提交', '提示', {
//              confirmButtonText: '确定',
//              callback: action => {
////                  this.$message({
////                    type: 'info',
...
//        }
      ...
      queryChangeStatus(event,tdKey){
//          输入数据监测、验证

//          console.log(tdKey,event);
